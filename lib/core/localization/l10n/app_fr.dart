const Map<String, String> appFr = {
  ...
  'filterByRegion': 'Par région',
  'sortAlphabeticalAZ': 'Alphabétique, de A à Z',
  'sortAlphabeticalZA': 'Alphabétique, de Z à A',
  ...
  'authoritiesTitle': 'Ils sont là pour vous aider !',
  'authoritiesBody':
  ...
  'addAnimalTitleAdd': 'AJOUTER\nUN ANIMAL',
  'addAnimalTitleEdit': 'MODIFIER\nL\'ANIMAL',
  'addAnimalImageRequired': 'Veuillez importer une image de l\'animal',
  'addAnimalCreateSuccess': 'Animal créé avec succès',
  'addAnimalUpdateSuccess': 'Animal mis à jour avec succès',
  'addAnimalSubmitError': 'Impossible d\'enregistrer l\'animal : {error}',
  'addAnimalSectionTitle': 'NOM DE MON ANIMAL',
  'addAnimalHintTitle': 'Saisir le nom de mon animal',
  'addAnimalValidationTitle': 'Le titre est requis',
  'addAnimalSectionDescription': 'DESCRIPTION',
  'addAnimalHintDescription': 'Rédiger la description de l\'animal',
  'addAnimalValidationDescription': 'La description est requise',
  'addAnimalSectionSpecies': 'ESPÈCE',
  'addAnimalHintSpecies': 'Sélectionner l\'espèce',
  'addAnimalSectionBreed': 'RACE',
  'addAnimalHintBreed': 'Saisir la race',
  'addAnimalValidationBreed': 'La race est requise',
  'addAnimalSectionGender': 'SEXE',
  'addAnimalHintGender': 'Sélectionner le sexe',
  'addAnimalSectionAge': 'ÂGE',
  'addAnimalHintAge': 'Sélectionner l\'âge',
  'addAnimalAgeJunior': 'Jeune',
  'addAnimalAgeAdult': 'Adulte',
  'addAnimalAgeSenior': 'Senior',
  'addAnimalSectionMicrochip': 'PUCE ÉLECTRONIQUE',
  'addAnimalHintMicrochip': 'L\'animal a-t-il une puce électronique ?',
  'addAnimalSectionTattoo': 'TATOUAGE',
  'addAnimalHintTattoo': 'L\'animal a-t-il un tatouage ?',
  'addAnimalSectionCollarOrHarness': 'COLLIER OU HARNAIS',
  'addAnimalHintCollarOrHarness': 'L\'animal en porte-t-il un ?',
  'addAnimalSectionPhoto': 'PHOTO',
  'addAnimalSelectedImagePreviewUnavailable':
      'Aperçu de l\'image sélectionnée indisponible',
  'addAnimalCurrentImageUnavailable': 'Image actuelle indisponible',
  'addAnimalSelectNewImageOptional':
      'Sélectionner une nouvelle image (optionnel)',
  'addAnimalSelectImage': 'Sélectionner une image',
  'addAnimalUpdateButton': 'METTRE À JOUR L\'ANIMAL',
  'addAnimalCreateButton': 'AJOUTER MON ANIMAL',
  'addAnimalFieldRequired': 'Ce champ est requis',
  ...
  'pointsNoEarnedHistory': 'Aucun historique de points gagnés pour le moment.',
  'pointsNoUsedHistory': 'Aucun historique de points utilisés pour le moment.',
  'pointsMyRedemptionsTitle': 'MES ÉCHANGES',
  'pointsNoRedemptionsYet': 'Aucun échange pour le moment.',
  'pointsRedeemedFor': 'Échangé pour {points} pts',
  'pointsStatusPending': 'En attente',
