...
class AppLocalizations {
  ...
  String get shareStoryShort => _text('shareStoryShort');
  String get addCaptionHint => _text('addCaptionHint');
  String get noLocalMessages => _text('noLocalMessages');
  String get imageUnavailable => _text('imageUnavailable');
  String get videoLoadFailed => _text('videoLoadFailed');
  String get comments => _text('comments');
  String get noCommentsYet => _text('noCommentsYet');
  String get writeCommentHint => _text('writeCommentHint');
  String get faqNoQuestionsTitle => _text('faqNoQuestionsTitle');
  String get contactsTitle => _text('contactsTitle');
  String get sheltersLabel => _text('sheltersLabel');
  String get veterinariansLabel => _text('veterinariansLabel');
  String get authoritiesLabel => _text('authoritiesLabel');
  String get partnersLabel => _text('partnersLabel');
  String get contactInformation => _text('contactInformation');
  String get descriptionLabel => _text('descriptionLabel');
  String get noDescriptionAvailable => _text('noDescriptionAvailable');
  String get web => _text('web');
  String get failedToLoadNotifications => _text('failedToLoadNotifications');
  String get noNotificationsYet => _text('noNotificationsYet');
  String get faqSupportRequestSubject => _text('faqSupportRequestSubject');
